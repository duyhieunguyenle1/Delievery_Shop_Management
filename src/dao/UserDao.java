...
public class UserDao {
    ...
    public void insert(int id,String username,String email,String password, String phone,
            String seq,String ans, String country)
    {
    ...
    public void updateUser(int id,String username,String email,String password, String phone,
        String seq,String ans, String country)
    {
        String sql ="update user set uname=?, uemail=?,upassword=?,uphone=?,usecqus=?,uans=?,ucountry=?";
        try {
            ps=con.prepareStatement(sql);
