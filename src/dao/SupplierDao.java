...
public class SupplierDao {
    ...
    // check if supplier username already exists
    ...
    public void insert(int id,String username,String email,String password, String phone,String country)
    {
    ...
    public void updateSupplier(int id,String username,String email,String password, String phone, String country){
        String sql ="update supplier set sname=?, semail=?,spassword=?,sphone=?,scountry=?";
        try {
            ps=con.prepareStatement(sql);
            ...
            if(ps.executeUpdate()>0){
                JOptionPane.showMessageDialog(null, "Supplier update successfully!");
            }
        } catch (SQLException ex) {
            Logger.getLogger(SupplierDao.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void delete(int id){
        int x = JOptionPane.showConfirmDialog(null, "Are you sure to delete this supplier?","Delete Supplier",JOptionPane.OK_CANCEL_OPTION,0);
