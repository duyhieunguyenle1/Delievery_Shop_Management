...
public class Signup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        questField = new javax.swing.JComboBox<>();
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(400, 765));
        setResizable(false);
        ...
        jPanel1.add(btnClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 10, -1, 40));
        ...
        jPanel1.add(idField, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 130, 302, 30));
        ...
        jPanel1.add(usernameField, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 190, 302, 30));
        ...
        jPanel1.add(emailField, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 250, 302, 30));
        ...
        jPanel1.add(passField, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 310, 300, 30));
        ...
        jPanel1.add(passAgainField, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 370, 300, 30));

        jLabel15.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(255, 255, 255));
        jLabel15.setText("Security question");
        jPanel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 530, -1, -1));
        ...
        jPanel1.add(phoneField, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 430, 302, 30));
        ...
        questField.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "What is your favorite color?", "What is your favorite game?", "What was your first school name?", "What is your pet name?", "What was your first car?" }));
        jPanel1.add(questField, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 550, 300, 30));

        jLabel17.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(255, 255, 255));
        jLabel17.setText("Answer");
        jPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 590, -1, -1));

        ansField.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jPanel1.add(ansField, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 610, 302, 30));

        jLabel18.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(255, 255, 255));
        jLabel18.setText("Country");
        jPanel1.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 470, -1, -1));

        countryField.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jPanel1.add(countryField, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 490, 302, 30));
        ...
        jPanel1.add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 670, 140, 40));
        ...
        jPanel1.add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 670, 140, 40));
        ...
        jPanel1.add(disablePassAgain, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 370, -1, 30));
        ...
        jPanel1.add(disablePass, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 310, -1, 30));
        ...
        jPanel1.add(enablePass, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 310, 30, 30));
        ...
        jPanel1.add(enablePassAgain, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 370, 30, 30));
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if(isEmpty()){
            ...
            String seq = questField.getSelectedItem().toString();
            String ans = ansField.getText();
            String country = countryField.getText();
            
            if(!user.isEmailExist(email)){
                if(!user.isPhoneExist(phone)){
                    user.insert(id, username, email, password, phone, seq, ans, country);
                    new Login().setVisible(true);
                    this.dispose();
                }else{
                    JOptionPane.showMessageDialog(this, "This phone number is already used","Warning",2);
                }
            }else{
                JOptionPane.showMessageDialog(this, "This email is already used","Warning",2);
            }
        }
...
//        }
    ...
    private javax.swing.JComboBox<String> questField;
